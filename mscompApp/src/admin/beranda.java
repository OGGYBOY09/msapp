...
public class beranda extends javax.swing.JPanel {
    ...
    private admin.Dashboard dashboardUtama;

    /**
     * Creates new form beranda
     * [UBAH] Constructor sekarang menerima parameter Dashboard
     */
    public beranda(admin.Dashboard dash) {
        initComponents();
        
        // Simpan Dashboard yang dikirim ke variabel lokal
        this.dashboardUtama = dash; 
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        if (dashboardUtama != null) {
            // Panggil method di Dashboard untuk ganti ke layar Kelola User
            dashboardUtama.bukaMenuKelolaUser();
        } else {
            System.out.println("Dashboard belum terhubung!");
        }
